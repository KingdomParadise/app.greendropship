		...
		<div class="wrapinsidecontent">
			<div class="profile">
				...
				<div class="nuform">
					...
					<div class="user-info">
						<label>Password: </label><input type="password" minlength="6" id="txt-password" class="simple-tooltip" title="more than 6 characters, lowercase, uppercase, number, symbol" autocomplete="new-password" required><i class="fa fa-eye" data-id="#txt-password"></i>
						<p id="password-error"></p>
					</div>
					<div class="user-info">
						<label>Confirm Password: </label><input type="password" minlength="6" class="simple-tooltip" id="txt-confirm-password" autocomplete="new-password" title="more than 6 characters, lowercase, uppercase, number, symbol" required><i class="fa fa-eye" data-id="#txt-confirm-password"></i>
