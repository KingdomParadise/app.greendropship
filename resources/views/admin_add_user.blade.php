			...
			<div class="profile">
				...
				<div class="nuform">
					...
					<div class="user-info">
						...
						<input type="password" minlength="6" class="simple-tooltip" id="txt-password" autocomplete="new-password" title="more than 6 characters, lowercase, uppercase, number, symbol" required><i class="fa fa-eye" data-id="#txt-password"></i>
						<p id="password-error"></p>
					</div>
					<div class="user-info">
						<label class="mt-3">Confirm Password<span>*</span></label>
						<input type="password" minlength="6" class="simple-tooltip" id="txt-confirm-password" autocomplete="new-password" title="more than 6 characters, lowercase, uppercase, number, symbol" required><i class="fa fa-eye" data-id="#txt-confirm-password"></i>
