        ...
        <div class="wrapinsidecontent">
            ...
            <div class="empty-product my-empty" style="display: none;">
                <div class="d-flex flex-column align-items-center">
                    <h2 class="my-3"><strong>Your store is empty!</strong></h2>
                    <h4 style="line-height: 1.5;" class="my-0">You don't have any product in your store.</h4>
                    <h4 style="line-height: 1.5;" class="my-0">Go to your import list to add products to your store.</h4>
                    <h4 style="line-height: 1.5;" class="my-0">If you have not created an import list yet, go to Search Products and add  products to your import list.</h4>
                    <h4 style="line-height: 1.5;" class="my-0">If the products from import list are published, they will be displayed.</h4>
